...
import {operationLoadFavoriteFilms} from "../../reducers/films-data/films-data";
...
export default compose(connect(mapStateToProps, mapDispatchToProps), withPrivatePath)(FavoriteMovies);
